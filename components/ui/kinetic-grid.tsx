...
const CELL_SIZE = 55; // Grid cell dimension in px
...
export default function KineticGrid({
  ...
  const draw = useCallback(
    (now: number) => {
      ...
      const theme = {
        ...
        monochrome: {
          bg: "#000000",
          lineActive: { r: 255, g: 255, b: 255, a: 0.92 },
      ...
      // Static background dot matrix texture
  ...
  useEffect(() => {
    ...
    // Initial pleasant subtle ripple at center on mount
